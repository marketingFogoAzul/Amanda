...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = f"postgresql://neondb_owner:npg_E9grjAHT3ubc@ep-young-cloud-a8makyxk-pooler.eastus2.azure.neon.tech/neondb?sslmode=require&channel_binding=require"
